...
TpList<TpBluetoothAddress> TpBluetoothLocal::pairedDevices()
{
    TpBluetoothLocalData *data = static_cast<TpBluetoothLocalData *>(data_);
...
TpList<TpBluetoothAddress> TpBluetoothLocal::connectedDevices()
{
    TpBluetoothLocalData *data = static_cast<TpBluetoothLocalData *>(data_);
    TpList<TpBluetoothAddress> device_list;
...
TpList<TpBluetoothUuid> TpBluetoothLocal::uuidList()
{
    TpBluetoothLocalData *data = static_cast<TpBluetoothLocalData *>(data_);
...
{
    TpBluetoothLocalData *data = static_cast<TpBluetoothLocalData *>(data_);
    TpList<TpBluetoothUuid> uuid_list = uuidList();
