...
public:
    ...
    {
        // 【计划】暂时默认RGB24
        TP_VIDEO_DECODE_RGB24 = TP_VIDEO_FORMAT_RGB24,
        TP_VIDEO_DECODE_BGR24 = TP_VIDEO_FORMAT_BGR24,
        TP_VIDEO_DECODE_RGBA8888 = TP_VIDEO_FORMAT_RGBA8888,
        TP_VIDEO_DECODE_IYUV = TP_VIDEO_FORMAT_IYUV,
        TP_VIDEO_DECODE_YUV2 = TP_VIDEO_FORMAT_YUV2,
        TP_VIDEO_DECODE_UYVY = TP_VIDEO_FORMAT_UYVY
    };
